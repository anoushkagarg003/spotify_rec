...
def gather_data(sp):
    ...
    for artist_id in artists.keys():
        process_similar_artists(sp, artist_id)
    
    return "Top tracks and potential recommendations have been successfully stored in the database."

def process_similar_artists(sp, artist_id):
...
def user_top_songs():
    ...
    return render_template('table.html', title='User Top Songs', items=user_top_songs)
